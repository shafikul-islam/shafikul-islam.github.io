...
<div class="section-news">
  <div class="card news-card">
    <div class="news-header">
      <h3 class="section-title">🗞️ Selected News</h3>
    ...
    <div class="news-scroller" id="newsScroller">
      <ul class="news-items">
        ...
        <li><div class="news-date">Dec 16, 2025</div><div class="news-text">🗣️ All three IISE submissions (healthcare, data analytics, and AI) were accepted for <strong>oral presentation</strong> at <strong>IISE Annual Conference & Expo 2026</strong>.</div></li>

        <li><div class="news-date">Nov 29, 2025</div><div class="news-text">✅ Paper <em>“Fracture Finder: Computer-Aided Real-Time Diagnosis of Vertebral Fractures in Thoracic Spine X-Rays Using YOLOv8 with Weighted Box Fusion and Augmentation Strategies”</em> accepted in <em>IISE Transactions on Healthcare Systems Engineering</em>.</div></li>

        <li><div class="news-date">Nov 2025</div><div class="news-text">📄 Paper <em>“Interpretable Forecasting of Dissolved Oxygen Leveraging Foundation Model for Proactive Aeration in Rural Wastewater Treatment Systems”</em> published in <em>Water Research</em> (2025).</div></li>

        <li><div class="news-date">Oct 25, 2025</div><div class="news-text">🥈 Runner-up, <strong>Stakeholder Engagement Data Challenge</strong> at <strong>INFORMS Annual Meeting 2025</strong>, for large-scale stakeholder analytics supporting strategy design for professional societies.</div></li>

        <li><div class="news-date">Oct 25, 2025</div><div class="news-text">🎤 Presented <em>“Privacy-Aware Porosity Prediction in Metal Additive Manufacturing using Hierarchical Graph Attention Networks”</em> at <strong>INFORMS Annual Meeting 2025</strong>.</div></li>

        <li><div class="news-date">Oct 2025</div><div class="news-text">🏅 Finalist, <strong>Stakeholder Engagement Data Challenge</strong>, INFORMS Annual Meeting 2025 (team lead).</div></li>

        <li><div class="news-date">Sep 2025</div><div class="news-text">🚀 Proposal recommended: <em>“Cross-Modality Domain Adaptation for Anomaly Detection in LPBF Systems”</em> (NASA EPSCoR CAN, Aug 2025).</div></li>

        <li><div class="news-date">Aug 01, 2025</div><div class="news-text">📢 Sports Secretary, <strong>Bangladeshi Student Association (BSA), LSU</strong>. Leading sports committees to foster community engagement among international students.</div></li>

        <li><div class="news-date">Aug 01, 2025</div><div class="news-text">📚 Three papers published in <em>Manufacturing Letters</em> (Q1).</div></li>

        <li><div class="news-date">Jul 01, 2025</div><div class="news-text">💡 Grant awarded: <strong>NSF LAMDA Seed Grant</strong> — <em>“Physics-Informed ML for Process Defect Detection and Fatigue Modeling in WAAM”</em>.</div></li>

        <li><div class="news-date">Jun 25, 2025</div><div class="news-text">🎤 Presented three works at <strong>NAMRC 2025</strong>.</div></li>

        <li><div class="news-date">Jun 5, 2025</div><div class="news-text">✈️ <strong>NSF Student Travel Award</strong>, <strong>NAMRC 2025</strong>, supporting conference attendance.</div></li>

        <li><div class="news-date">Jun 03, 2025</div><div class="news-text">🏆 <strong>Champion</strong>, <strong>IISE Innovative Design Competition</strong>, IISE Annual Conference & Expo 2025, for “Hearth AI — Meaningful Connection at your Fingertips”.</div></li>

        <li><div class="news-date">Jun 02, 2025</div><div class="news-text">🥉 2nd Runner-up, <strong>QCRE Data Challenge</strong>, IISE Annual Conference & Expo 2025.</div></li>

        <li><div class="news-date">May 31, 2025</div><div class="news-text">🎤 Presented two works at <strong>IISE 2025</strong> on <strong>graph neural networks</strong> and <strong>vision transformers</strong>.</div></li>

        <li><div class="news-date">Apr 2025</div><div class="news-text">✈️ <strong>NSF Student Travel Award</strong>, IISE Annual Conference & Expo 2025.</div></li>

        <li><div class="news-date">Feb–Mar 2025</div><div class="news-text">💼 NSF Southwest I-Corps IdeaLaunch Program: <strong>Privacy-preserving certification framework</strong> for AMaaS platforms (Role: Entrepreneurial Lead).</div></li>

        <li><div class="news-date">Mar 15, 2025</div><div class="news-text">🏆 Best graduate oral presentation award for <em>“Foundation Model-Driven Predictive and Interpretable Modeling for Critical Materials in Renewable Energy Applications”</em> (Materials Science/Engineering Division).</div></li>

        <li><div class="news-date">Jan 28, 2025</div><div class="news-text">📄 Abstract accepted at the <strong>99th Annual Meeting</strong> of the Louisiana Academy of Sciences.</div></li>

        <li><div class="news-date">Jan 04, 2025</div><div class="news-text">🎓 Started PhD in Mechanical and Industrial Engineering at LSU.</div></li>

        <li><div class="news-date">Dec 25, 2024</div><div class="news-text">🏅 Best Technical Presentation (Session ICCIT-2024) for “Predict Students’ Performance and Optimize Preparatory Leave: An Integrated Deep Learning and Dynamic Programming Approach”.</div></li>

        <li><div class="news-date">Dec 26, 2024</div><div class="news-text">👨🏫 Served as an instructor for the CIOL Winter ML Bootcamp.</div></li>

        <li><div class="news-date">Dec 16, 2024</div><div class="news-text">🗣️ Two IISE abstracts accepted for oral presentation at IISE Annual Conference & Expo 2025.</div></li>

        <li><div class="news-date">Oct 01, 2024</div><div class="news-text">👥 Two mentored works accepted at DigiTwin 2024 Conference.</div></li>

        <li><div class="news-date">Apr 2024</div><div class="news-text">🎓 University Merit Scholarship, Shahjalal University of Science and Technology (2020–2024), Top 5% for four consecutive years.</div></li>

        <li><div class="news-date">Jan 2024</div><div class="news-text">📄 Paper accepted at an AAAI-24 workshop.</div></li>

        <li><div class="news-date">Oct 2023</div><div class="news-text">📄 Paper accepted at a NeurIPS’23 workshop.</div></li>

        <li><div class="news-date">Mar 2022</div><div class="news-text">🚀 Founded CIOL to bridge Industrial & Production Engineering and AI through research.</div></li>
...
<div class="section-research">
  ...
  <div class="center-cta">
    <a href="{{ '/publications/' | relative_url }}" class="btn">📚 See Full Research & Publications →</a>
  </div>
</div>
